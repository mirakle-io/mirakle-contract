...
const func: DeployFunction = async ({ deployments, getNamedAccounts }) => {
  ...
  await execute("BGTX", { from: deployer, log: true }, "setMinter", deployer, true);
  await execute("BGTX", { from: deployer, log: true }, "mint", deployer, "100000000000000000000000");

  await execute("BGTX", { from: deployer, log: true }, "mint", deployer, "100000000000000000000000");


  await execute("BGTX", { from: deployer, log: true }, "approve", "0xd7f655e3376ce2d7a2b08ff01eb3b1023191a901", "1000000000000000000000000000");

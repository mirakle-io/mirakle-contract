...
const func: DeployFunction = async ({ deployments, getNamedAccounts , getChainId}) => {
 ...
 await execute("Qiji", { from: deployer, log: true }, "approve",timelock.address,"1000000000000");
  ...
  await execute("Timelock", { from: deployer, log: true },"signalApprove",Qiji.address,deployer,"100000000");
